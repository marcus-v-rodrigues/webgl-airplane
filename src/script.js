...
const createLight = () => {
  ...
  shadowLight.applyMatrix4(doTranslation(1, 1, 1));
...
const createPlane = () => {
  ...
  stabilizerPlane.applyMatrix4(doTranslation(-90, -10, 0));
...
const flyParticle = () => {
  ...
  particle.applyMatrix4(doTranslation(
                                      xLimit, 
                                      Math.random() * yLimit * 2 - yLimit, 
                                      Math.random() * maxParticlesZ
                                    ));
...
const init = () => {
  ...
  camera.applyMatrix4(doTranslation(0, 0, 1000));
...
const loop = () => {
  ...
  plane.applyMatrix4(doScale(1 + v2, 1 - v2, 1 - v2));
